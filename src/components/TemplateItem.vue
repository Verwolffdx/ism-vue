    ...
    <div class="document">
        <div>
            <div class="title">
                ...
                <router-link class="document_title" :to="`/smk/document/${template.document_id}`">
                    <span v-html="template.template_name"></span>
                    <br>
                    <div class="document_content">
                        <span v-html="template.document_code"></span>
                        <span>&nbsp;</span>
                        <span v-html="template.document_name"></span>
                    </div>

                </router-link>
                <my-button class="document__btns" @click="this.getTemplateFile(template.template_name)">Скачать</my-button>
